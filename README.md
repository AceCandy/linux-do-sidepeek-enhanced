...
- 修复 Alt/Option + 上下键切帖后首帖顶部被遮挡、无法向上滚动恢复的问题。
- 禁止抽屉外层意外滚动，正文滚动、楼层定位及回顶保持可用；扩展和油猴脚本同步更新。
...
- 修复带楼层定位的长帖无法继续加载回复，刷新后可下滑查看新增楼层，无需关闭重开。
- 刷新绕过进行中的预取，主题请求重新获取服务器数据；分页返回空结果时可重试。
- 移除底部重复的预览数量提示，保留加载状态；扩展与油猴脚本同步更新。
